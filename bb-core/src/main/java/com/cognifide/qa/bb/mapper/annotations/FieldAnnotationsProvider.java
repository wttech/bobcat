...
public final class FieldAnnotationsProvider {
  ...
  public final static AbstractAnnotations create(Field field, Injector injector){
    ...
    throw new IllegalArgumentException("Field is not marked by any supported annotation: " + field.toGenericString());
  }
