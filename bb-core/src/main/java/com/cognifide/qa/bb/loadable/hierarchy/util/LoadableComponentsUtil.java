...
public class LoadableComponentsUtil {
   ...
   * @return List of Condition Context objects describing conditions provided in the
   *         {@link LoadableComponent} annotations
   */
  public static List<ConditionContext> getConditionsFormField(Field field) {
    ...
    for (LoadableComponent loadableComponent : field
        .getAnnotationsByType(LoadableComponent.class)) {
      fieldConditionContext.add(new ConditionContext(loadableComponent, field.getName(),
