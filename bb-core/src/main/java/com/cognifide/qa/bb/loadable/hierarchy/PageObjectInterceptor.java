...
/**
 * This class registers instances of classes annotated with {@link PageObject} annotation
 */
public class PageObjectInterceptor implements MethodInterceptor {
  ...
  public Object invoke(MethodInvocation methodInvocation) throws Throwable {
    Class<?> clazz = AopUtil.getBaseClassForAopObject(
        Class.forName(Thread.currentThread().getStackTrace()[8].getClassName()));
