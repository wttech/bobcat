...
/**
 * SystemType is an enum that represents type of operating system. It provides a {@link #current() current}
 * method to retrieve an instance of SystemType that represents currently used operating system.
 */
