 ...
 */
public class ActivePageObjectProvider implements FieldProvider {
  ...
  public boolean accepts(Field field) {
    return (field.getType().isAnnotationPresent(PageObject.class)
        ...
        && AnnotationsHelper.isConfigurablePageObjectAnnotationPresent(field) && isNotList(field);
  ...
  public Optional<Object> provideValue(Object pageObject, Field field, PageObjectContext context) {
    ...
    String path = field.getAnnotation(ConfigurablePageObject.class).path();
