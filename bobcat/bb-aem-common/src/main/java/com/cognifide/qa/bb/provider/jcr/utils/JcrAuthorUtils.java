 ...
 */
public class JcrAuthorUtils extends JcrUtils {

  @Inject
  @Named(AemConfigFilenames.AUTHOR_PROPERTIES)
  private InstanceProperties authorProperties;

  /**
   * @return instance of properties for author environment
   */
  @Override
