...
/**
 * This entry represents a hard assertion that failed.
 */
public class AssertionFailedEntry extends LogEntry {
  ...
  /**
   * Constructs the AssertionFailedEntry.
   *
   * @param assertionError the event that should be logged
   */
  ...
  /**
   * @return AssertionError instance that contains more information.
   */
