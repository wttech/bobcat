...
public class ProxyLoggerTest {
  ...
  private ClosestHarEntryElector elector = mock(ClosestHarEntryElector.class);
  private RequestPredicate matchingPredicate = mock(RequestPredicate.class);
  private Har har = mock(Har.class, RETURNS_DEEP_STUBS);
  private HarEntry closestHarEntry = mock(HarEntry.class, RETURNS_DEEP_STUBS);
